...
/*
 * Dual-mode select (sampled once at power-up / gpio_init):
 *   MODE_SEL HIGH or floating -> DAPLink (SWD / CMSIS-DAP)
 *   MODE_SEL LOW (to GND)     -> ESP32 auto-download (CDC DTR/RTS -> EN/IO0)
 */
#define MODE_SEL_PORT                GPIOB
#define MODE_SEL_PIN                 GPIO_PIN_1
#define MODE_SEL_PIN_Bit             1

/* ESP32 EN shares the DAPLink nRESET pin (PB0) */
...
/* CDC UART to ESP32 / target (USART2) — already used by DAPLink CDC */
